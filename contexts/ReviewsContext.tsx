...
const defaultReviews: Review[] = [
  {
    ...
    text: "если честно сначала думал что развод, ну как можно за пару недель научится делать сайты?? но решил купить курс и понял что реально работает, AI помогает во всем. уже сделал 2 сайта, один для себя другой для друга",
    rating: 5,
  ...
  },
  {
    ...
    text: "Долго сомневалась платить или нет, цена кусается... Но взяла и не жалею! За месяц окупила курс полностью, беру заказы на фрилансе. Главное что AI реально помогает когда застряла",
    rating: 5,
  ...
  },
  {
    ...
    text: "Скептически относился ко всем этим онлайн курсам. Но решил рискнуть и купил, не пожалел. Прошел курс за месяц. Теперь подрабатываю на фрилансе, уже 3 сайта сделал",
    rating: 5,
