...
const defaultReviews: Review[] = [
  {
    ...
    text: "ооо бро это просто огонь 🔥 вчера сделал свой первый сайт.... не могу поверить что это я сделал)) думал будет сложно но этот АИ прям шаг за шагом все объясняет. кста за 100 баксов это ДЕШЕВО для такого контента имхо",
    rating: 5,
