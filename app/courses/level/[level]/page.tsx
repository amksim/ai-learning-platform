  ...
  "1": {
    ...
    sections: [
      ...
      },
      {
        ...
        content: "Курс стоит $399 (скидка 33%, обычно $599). Пожизненный доступ ко всем урокам. Скидка действует 1 час с первого посещения!",
      },
    ],
    tasks: [
      "Изучи вводную часть",
  ...
  "3": {
    ...
    sections: [
      ...
      },
      {
        ...
        content: "Фриланс ($30-100/час), продажа готовых решений ($399-2000), платные сервисы ($200-2000/месяц), свой бизнес!",
      },
      {
        title: "Готов начать?",
